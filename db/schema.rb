...
ActiveRecord::Schema.define(version: 20171019031205) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "api_settings", force: :cascade do |t|
    t.bigint "saved_setting_id"
    t.string "api_1_url", null: false
    t.string "api_endpoint_1", null: false
    t.string "api_endpoint_2"
    t.string "api_endpoint_3"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["saved_setting_id"], name: "index_api_settings_on_saved_setting_id"
  end

  create_table "color_palette_settings", force: :cascade do |t|
    t.bigint "saved_setting_id"
    t.integer "active_color_palette", default: 0, null: false
    t.string "hex_1", null: false
    t.string "hex_2"
    t.string "hex_3"
    t.string "hex_4"
    t.integer "percentage_hex_1", default: 100
    t.integer "percentage_hex_2", default: 100
    t.integer "percentage_hex_3", default: 100
    t.integer "percentage_hex_4", default: 100
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["saved_setting_id"], name: "index_color_palette_settings_on_saved_setting_id"
  end
  ...
  create_table "effect_settings", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["saved_setting_id"], name: "index_effect_settings_on_saved_setting_id"
  end
  ...
  create_table "saved_settings", force: :cascade do |t|
    t.bigint "product_id"
    t.integer "master_brightness", default: 255, null: false
    t.boolean "energy_saver", default: false, null: false
    t.string "active_effect", default: "0", null: false
    t.string "active_color_palette", default: "0", null: false
    t.string "active_api"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["product_id"], name: "index_saved_settings_on_product_id"
  end
  ...
  create_table "schedule_settings", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["saved_setting_id"], name: "index_schedule_settings_on_saved_setting_id"
  end
